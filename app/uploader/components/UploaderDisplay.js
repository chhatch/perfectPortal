...
import { setSelectedProject, uploadPics, retryFailed } from "../../uploader/actions/actions.js"
...
let UploaderDisplay = (props) => {
    return (
        <div>
            ...
            < FileCounter pendingUploads={props.pendingUploads} successfulUploads={props.successfulUploads} failedUploads={props.failedUploads} retryFailed={props.retry}/>
        </div>
    );
}
